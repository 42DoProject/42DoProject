        ...
        {loginState === null ? (
          <button className="Nav__user__login">
            <a
              ...
              href={`https://api.intra.42.fr/oauth/authorize?client_id=${process.env.REACT_APP_API_CLIENT_ID}&redirect_uri=http://${process.env.REACT_APP_DOMAIN_NAME}:3000/auth&response_type=code`}
            >
              SIGN IN
            </a>
          </button>
