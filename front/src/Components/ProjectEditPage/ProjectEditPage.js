    ...
    <div className="project-edit__wrapper">
      ...
      >
        ...
        <input
          ...
          placeholder="프로젝트명을 입력해주세요. (ex. 식재료에 따른 요리 추천 앱)"></input>
        <label>
        ...
        <Editor height="600px" />
        {/* <textarea
          className="project-edit__introduction"
          placeholder={`프로젝트를 소개해주세요.
(ex. 프로젝트의 목적, 기능, 필요성, 출시 플랫폼, 타겟 유저, 참고 링크 등)`}></textarea> */}
        <label>
          프로젝트에 필요한 포지션
          <span className="project-edit__asterisk">*</span>
        </label>
        <div className="project-edit__position"></div>
        <label>프로젝트 완료까지의 예상 소요 기간</label>
        <div>
          시작일 <input type="date"></input> ~ 종료일{" "}
          <input type="date"></input>
          <span>(일)</span>
        </div>
        <label>프로젝트에 필요한 스킬</label>
